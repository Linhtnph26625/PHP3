                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="product_gallery fix">
                                            <div class="product_gallery_thumb">
                                                <img src="{{asset('bootstrap\image\product\product2.jpg')}}" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="{{asset('bootstrap\image\product\product3.jpg')}}" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="{{asset('bootstrap\image\product\product4.jpg')}}" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="{{asset('bootstrap\image\product\product5.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
