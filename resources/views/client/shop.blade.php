                            ...
                            <div class="row">
                                    <div class="col-lg-9 col-md-12">
                                        ...
                                        <div class="banner_slider mb-35">
                                            <img src="{{asset('bootstrap\image\banner\bannner10.jpg')}}" alt="">
                                        </div>
                                        <!--banner slider start-->
                                                ...
                                                <div class="tab-pane fade" id="list" role="tabpanel">
                                                    ...
                                                    <div class="product_list_item mb-35">
                                                        <div class="row align-items-center">
                                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                                <div class="product_thumb">
                                                                   <a href="single-product.html"><img src="{{asset('bootstrap\image\product\product5.jpg')}}" alt=""></a>
                                                                   <div class="img_icone">
                                                                       <img src="{{asset('bootstrap\image\cart\span-new.png')}}" alt="">
                                                                   </div>
                                                                </div>
                                        ...
                                        <div class="sidebar_widget special">
                                            ...
                                            <div class="special_product_inner mb-20">
                                                <div class="special_p_thumb">
                                                    <a href="#"><img src="{{asset('bootstrap\image\cart\cart3.jpg')}}" alt=""></a>
                                                </div>
                                            ...
                                            <div class="special_product_inner">
                                                <div class="special_p_thumb">
                                                    <a href="#"><img src="{{asset('bootstrap\image\cart\cart18.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="small_p_desc">
                                                    <div class="product_ratting">
                                                       <ul>
